...
function CreateAndAssign({ embedded = false }) {
  ...
  useEffect(() => {
    if (projects.length > 0 && !selectedProject) {
      const bitfinexProject = projects.find(p => p.name.toLowerCase().includes('bitfinex'))
      if (bitfinexProject) setSelectedProject(bitfinexProject)
    }
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <Space>
                    ...
                    />
                    <Text strong>Available Scripts ({filteredScripts.length - selectedScriptIds.size})</Text>
                  </Space>
